...
pub fn FriendsConnect(
    ...
    #[prop(optional)] connection_mode: Option<ReadSignal<ConnectionModalMode>>,
    #[prop(optional)] set_connection_mode: Option<WriteSignal<ConnectionModalMode>>,
) -> impl IntoView {
...
#[test]
fn test_connection_modal_mode_equality() {
    assert_eq!(ConnectionModalMode::Add, ConnectionModalMode::Add);
    assert_eq!(ConnectionModalMode::View, ConnectionModalMode::View);
    assert_ne!(ConnectionModalMode::Add, ConnectionModalMode::View);
}
